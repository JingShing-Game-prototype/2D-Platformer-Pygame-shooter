...
class UI:
    ...
    def weapon_overlay(self, weapon_index, has_switched):
        bg_rect = self.selection_box(10, self.screen.get_size()[1] - 90, has_switched) # weapon
    ...
    def advanced_health(self, player):
        ...
        # black bg
        pygame.draw.rect(self.screen, UI_BG_COLOR, (10, 10, player.health_bar_length, BAR_HEIGHT))
        # health bar
        ...
        # outline
        pygame.draw.rect(self.screen, UI_BORDER_COLOR, (10, 10, player.health_bar_length, BAR_HEIGHT), 3)
        ...
        self.screen.blit(health_value_surf, health_value_rect)
